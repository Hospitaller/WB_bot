...
def main():
    ...
    async def info(update: Update, context: ContextTypes.DEFAULT_TYPE):
        try:
            ...
            message = (
                "🤖 *Информация о боте*\n\n"
                "📝 *Демонстрация форматирования Markdown:*\n\n"
                ...
                "[Ссылка на Wildberries](https://www.wildberries.ru/)\n\n"
                "📊 *Таблица:*\n"
                "| Функция | Описание |\n"
                "|---------|----------|\n"
                "| Остатки | Проверка остатков |\n"
                "| Коэффициенты | Проверка коэффициентов |\n\n"
                "⚠️ *Важно:*\n"
                "> Это демонстрационное сообщение\n"
                "> с различными элементами форматирования\n\n"
                "🎯 *Дополнительно:*\n"
                "• Эмодзи: 🚀 💡 📈 📉\n"
                "• Цитаты: > Цитата\n"
                "• Код: `inline code`\n\n"
                "📌 *Заключение:*\n"
                "Это тестовое сообщение демонстрирует все возможности форматирования Markdown в Telegram боте."
            )
